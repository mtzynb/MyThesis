...
# CKSAAP_90 = 'CKSAAP_90_mixed_normalized_modified_cols_name.tsv'
# ------------ output files -------------
combined_features_out = 'NMBroto_CKSAAP_combined_90_mixed_normalized.csv'
# ---------------------------------------
# ged df from cdhit 90 data
NMBoroto_90_df = get_data_frame_from_tsv_file(NMBoroto_90)  # acc= 0.75
CKSAAP_90_df = get_data_frame_from_tsv_file(CKSAAP_90)  # acc= 0.77
# ---------------------------------------
# concat all features
...
print(combined_features_df.shape)  # (940, 1633)

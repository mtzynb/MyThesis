...
KSCTriad_90 = 'KSCTriad_90_mixed_normalized_modified_cols_name.tsv'
# ------------ output files -------------
combined_features_out = 'NMBroto_KSCTriad_combined_90_mixed_normalized.csv'
# ---------------------------------------
...
print(combined_features_df.shape)  # (940, 719)

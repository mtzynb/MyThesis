...
# ------------ input files -------------
combined_normalized_90 = 'NMBroto_KSCTriad_combined_90_mixed_normalized.csv'
# ------------ output files -------------
dropdup_90 = 'NMBroto_KSCTriad_combined_90_mixed_normalized_drpdup.tsv'
# ---------------------------------------
...
print("After drop 90 cdhit, shape= ", df90.shape)  # (940, 719) => (940, 714)

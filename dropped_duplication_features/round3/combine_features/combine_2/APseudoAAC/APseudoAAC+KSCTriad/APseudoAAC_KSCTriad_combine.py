...
# ------------ output files -------------
combined_features_out = 'APseudoAAC_KSCTriad_combined_90_mixed_normalized.csv'
# ---------------------------------------
...
# ---------------------------------------
# concat all features
combined_features_df = pd.concat([KSCTriad_90_df,
...
print(combined_features_df.shape)  # (940, 715)

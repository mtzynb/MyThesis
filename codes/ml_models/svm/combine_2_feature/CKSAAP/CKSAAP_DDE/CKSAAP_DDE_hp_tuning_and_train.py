...
# -------------- X,Y ---------------------
pca_features_90 = '../../../../../../pca_features/round3/combined_features/combine_2/CKSAAP/CKSAAP_DDE/CKSAAP_DDE_90_mixed_pca.tsv'
label_90 = '../../../../../../pca_features/round3/combined_features/combine_2/CKSAAP/CKSAAP_DDE/pca_feature_labels.tsv'
...
# ------------------------- save state -------------------------
utility.save_model("CKSAAP_DDE_svm_after_hp1_best_model.sav", svm_random_model.best_estimator_)
pprint("model saved.")

model_result_log.svm_model_log("CKSAAP_DDE_svm_after_hp1_model_log.txt",
...
svm_model_train = svm_classifier.train_predict_log(x_train=x90_train,
                                                   ...
                                                   log_filename='CKSAAP_DDE_svm_rbf_eval_after_test_log.txt')
# --------------------------------------------------
utility.save_model("CKSAAP_DDE_svm_rbf_model_train.sav", svm_model_train)
print("model saved.")
# --------------------------------------------------

...
params = {'n_estimators': 400, 'min_samples_split': 5, 'min_samples_leaf': 1,
...
utility.save_model("PseudoAAC_rf_model_train.sav", rfc_model)
print("model saved.")
end = time.time()
...
rf.evaluate_and_log(rfc_model,
                    ...
                    log_filename="PseudoAAC_rf_eval_after_test_log.txt")

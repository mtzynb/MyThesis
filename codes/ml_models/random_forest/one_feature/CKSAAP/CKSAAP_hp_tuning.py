...
plot_rf.plot_rf_model(rf_random_model.cv_results_, scoring=rf_random_model.scoring,
                      figname="CKSAAP_rf_after_hp1_plot.png")
pprint("model fig saved.")

utility.save_model("CKSAAP_rf_after_hp1_best_model.sav", rf_random_model.best_estimator_)
pprint("model saved.")

model_result_rf.rf_model_log("CKSAAP_rf_after_hp1_model_log.txt",

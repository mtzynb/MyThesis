...
params ={'n_estimators': 400, 'min_samples_split': 5,
...
utility.save_model("QSOrder_DDE_rfmodel_train.sav", rfc_model)
print("model saved.")
end = time.time()
...
rf.evaluate_and_log(rfc_model,
                    ...
                    log_filename="QSOrder_DDE_rfeval_after_test_log.txt")
